...
class TutorialCache implements TutorialRepository {
  ...
  @override
  StreamSubscription<List<TutorialModel>> listen(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<TutorialModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {

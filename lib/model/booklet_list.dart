...
typedef BookletWidgetProvider = Function(BookletModel? value);

class BookletListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final BookletWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final BookletListWidgetState? state;
  ...
  BookletListWidgetState createState() {
    return BookletListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = BookletListWidgetState();

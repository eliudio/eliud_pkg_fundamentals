  ...
  Widget build(BuildContext context) {
    ...
    if (formAction == FormAction.ShowData) {
      return BlocProvider<TutorialEntryFormBloc >(
            create: (context) => TutorialEntryFormBloc(AppBloc.appId(context),
      ...
      return Scaffold(
        appBar: formAction == FormAction.UpdateAction ?
                AppBar(
                    title: Text("Update TutorialEntry", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                  ) :
                AppBar(
                    title: Text("Add TutorialEntry", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                ),
...
class _MyTutorialEntryFormState extends State<MyTutorialEntryForm> {
  ...
  bool _readOnly(AccessState accessState, AppState appState, TutorialEntryFormInitialized state) {

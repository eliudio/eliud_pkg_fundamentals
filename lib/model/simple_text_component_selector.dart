...
class SimpleTextComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<SimpleTextListBloc>(
      ...
      child: SelectSimpleTextWidget(app: app,
          height: height,
...
class _SelectSimpleTextWidgetState extends State<SelectSimpleTextWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<SimpleTextListBloc>(context).add(
            SimpleTextChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SimpleTextListBloc, SimpleTextListState>(
      ...
      if ((state is SimpleTextListLoaded) && (state.values != null)) {

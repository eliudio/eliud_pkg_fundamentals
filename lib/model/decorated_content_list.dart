...
typedef DecoratedContentWidgetProvider = Function(DecoratedContentModel? value);

class DecoratedContentListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final DecoratedContentWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final DecoratedContentListWidgetState? state;
  final bool? isEmbedded;

  DecoratedContentListWidget(
      {super.key,
      required this.app,
      this.readOnly,
      this.form,
  ...
  DecoratedContentListWidgetState createState() {
    return DecoratedContentListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = DecoratedContentListWidgetState();
    var accessState = AccessBloc.getState(context);
    return state.fab(context, accessState);
  }
}

class DecoratedContentListWidgetState
    extends State<DecoratedContentListWidget> {

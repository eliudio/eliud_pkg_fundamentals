  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<DynamicWidgetListBloc>(
          ...
          dynamicWidgetRepository:
              dynamicWidgetRepository(appId: appId)!,
          )..add(LoadDynamicWidgetList()),
      child: SelectDynamicWidgetWidget(app: app,
          height: height,
...
class SelectDynamicWidgetWidget extends StatefulWidget {
  final AppModel app;
  final double height;
  ...
  const SelectDynamicWidgetWidget(
      {Key? key,
      required this.app,
  ...
  @override
  _SelectDynamicWidgetWidgetState createState() {
    return _SelectDynamicWidgetWidgetState();
  }
}

class _SelectDynamicWidgetWidgetState extends State<SelectDynamicWidgetWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<DynamicWidgetListBloc>(context).add(
            DynamicWidgetChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }

...
import 'decorated_content_list_bloc.dart';
import 'decorated_content_list_event.dart';
...
class DecoratedContentComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<DecoratedContentListBloc>(
      ...
      child: SelectDecoratedContentWidget(app: app,
          height: height,
...
class SelectDecoratedContentWidget extends StatefulWidget {
  ...
  @override
  _SelectDecoratedContentWidgetState createState() {
    return _SelectDecoratedContentWidgetState();
  }
}

class _SelectDecoratedContentWidgetState extends State<SelectDecoratedContentWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<DecoratedContentListBloc>(context).add(
            DecoratedContentChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }

  Widget theList(BuildContext context, List<DecoratedContentModel?> values) {
    var app = widget.app; 
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DecoratedContentListBloc, DecoratedContentListState>(
      ...
      if ((state is DecoratedContentListLoaded) && (state.values != null)) {

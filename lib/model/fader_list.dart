...
typedef FaderWidgetProvider = Function(FaderModel? value);

class FaderListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final FaderWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final FaderListWidgetState? state;
  ...
  FaderListWidgetState createState() {
    return FaderListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = FaderListWidgetState();

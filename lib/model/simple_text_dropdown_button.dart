...
class SimpleTextDropdownButtonWidget extends StatefulWidget {
  ...
  SimpleTextDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
List<Widget> widgets(SimpleTextModel pm) {
var widgets = <Widget>[];

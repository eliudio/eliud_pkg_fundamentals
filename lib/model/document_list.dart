...
typedef DocumentWidgetProvider = Function(DocumentModel? value);

class DocumentListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final DocumentWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final DocumentListWidgetState? state;
  ...
  DocumentListWidgetState createState() {
    return DocumentListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = DocumentListWidgetState();

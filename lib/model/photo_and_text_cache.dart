...
class PhotoAndTextCache implements PhotoAndTextRepository {

  final PhotoAndTextRepository reference;
  final Map<String, PhotoAndTextModel> fullCache = Map();

  PhotoAndTextCache(this.reference);
  ...
  Future<PhotoAndTextModel> get(String id, {Function(Exception) onError}) {
    PhotoAndTextModel value = fullCache[id];
  ...
  @override
  StreamSubscription<List<PhotoAndTextModel>> listen(trigger, {String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
    return reference.listen(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<List<PhotoAndTextModel>> listenWithDetails(trigger, {String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
    return reference.listenWithDetails(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<PhotoAndTextModel> listenTo(String documentId, changed) {
    reference.listenTo(documentId, changed);
  }

  static Future<PhotoAndTextModel> refreshRelations(PhotoAndTextModel model) async {

...
typedef DynamicWidgetChanged(String? value, int? privilegeLevel,);
...
class DynamicWidgetDropdownButtonWidget extends StatefulWidget {
  ...
  DynamicWidgetDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return DynamicWidgetDropdownButtonWidgetState();
  }
}

class DynamicWidgetDropdownButtonWidgetState extends State<DynamicWidgetDropdownButtonWidget> {
  DynamicWidgetListBloc? bloc;

  DynamicWidgetDropdownButtonWidgetState();

  @override
  void didChangeDependencies() {
    bloc = BlocProvider.of<DynamicWidgetListBloc>(context);
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a dynamicWidget'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'dynamicWidgets', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<DynamicWidgetListBloc>(context).add(DynamicWidgetChangeQuery(

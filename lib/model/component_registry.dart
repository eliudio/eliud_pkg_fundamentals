...
class ComponentRegistry {
  ...
  void init() {
    Registry.registry()!.addInternalComponents('eliud_pkg_fundamentals', ["decoratedContents", "dividers", "faders", "grids", "presentations", "simpleImages", "simpleTexts", "tutorials", "booklets", "documents", ]);

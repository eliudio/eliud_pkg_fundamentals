...
typedef TutorialWidgetProvider = Function(TutorialModel? value);

class TutorialListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final TutorialWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final TutorialListWidgetState? state;
  ...
  TutorialListWidgetState createState() {
    return TutorialListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = TutorialListWidgetState();

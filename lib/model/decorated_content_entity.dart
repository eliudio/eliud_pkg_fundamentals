...
class DecoratedContentEntity implements EntityBase {
  ...
  static DecoratedContentEntity? fromMap(Object? o, {Map<String, String>? newDocumentIds}) {
  ...
  static DecoratedContentEntity? fromJsonString(String json, {Map<String, String>? newDocumentIds}) {

...
class SimpleImageCache implements SimpleImageRepository {
  ...
  @override
  StreamSubscription<List<SimpleImageModel>> listen(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<SimpleImageModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {

...
class SimpleImageCache implements SimpleImageRepository {
  ...
  @override
  StreamSubscription<List<SimpleImageModel>> listen(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<SimpleImageModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {

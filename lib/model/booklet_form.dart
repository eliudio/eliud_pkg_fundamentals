  ...
  Widget build(BuildContext context) {
    ...
    if (formAction == FormAction.ShowData) {
      return BlocProvider<BookletFormBloc >(
            create: (context) => BookletFormBloc(AppBloc.appId(context),
                                       formAction: formAction,
      ...
      return Scaffold(
        appBar: formAction == FormAction.UpdateAction ?
                AppBar(
                    title: Text("Update Booklet", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                  ) :
                AppBar(
                    title: Text("Add Booklet", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                ),
...
class _MyBookletFormState extends State<MyBookletForm> {
      ...
      if (state is BookletFormInitialized) {
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is DocumentIDBookletFormError ? state.message : null;
                  },
                ),
          );
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is NameBookletFormError ? state.message : null;
                  },
                ),
          );
  ...
  bool _readOnly(AccessState accessState, AppState appState, BookletFormInitialized state) {

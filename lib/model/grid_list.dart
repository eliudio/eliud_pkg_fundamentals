...
typedef GridWidgetProvider = Function(GridModel? value);

class GridListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final GridWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final GridListWidgetState? state;
  ...
  GridListWidgetState createState() {
    return GridListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = GridListWidgetState();

...
typedef SimpleImageChanged(String? value, int? privilegeLevel,);
...
class SimpleImageDropdownButtonWidget extends StatefulWidget {
  ...
  SimpleImageDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return SimpleImageDropdownButtonWidgetState();
  }
}

class SimpleImageDropdownButtonWidgetState extends State<SimpleImageDropdownButtonWidget> {
  SimpleImageListBloc? bloc;

  SimpleImageDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'simpleImages', widget.value, (newValue, _) {
                  setState(() {

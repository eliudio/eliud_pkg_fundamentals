...
class DocumentComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<DocumentListBloc>(
      ...
      child: SelectDocumentWidget(app: app,
          height: height,
...
class SelectDocumentWidget extends StatefulWidget {
  ...
  @override
  _SelectDocumentWidgetState createState() {
    return _SelectDocumentWidgetState();
  }
}

class _SelectDocumentWidgetState extends State<SelectDocumentWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<DocumentListBloc>(context).add(
            DocumentChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }

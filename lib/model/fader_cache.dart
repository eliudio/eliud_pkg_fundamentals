...
class FaderCache implements FaderRepository {
  ...
  @override
  StreamSubscription<List<FaderModel>> listen(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<FaderModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {

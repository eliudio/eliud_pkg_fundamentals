...
class _SelectDividerWidgetState extends State<SelectDividerWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<DividerListBloc>(context).add(
            DividerChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DividerListBloc, DividerListState>(
      ...
      if ((state is DividerListLoaded) && (state.values != null)) {

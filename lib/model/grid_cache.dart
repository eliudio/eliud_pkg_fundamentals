...
class GridCache implements GridRepository {
  ...
  @override
  StreamSubscription<List<GridModel>> listen(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<GridModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {

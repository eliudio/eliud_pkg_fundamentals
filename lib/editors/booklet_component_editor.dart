...
class BookletComponentEditorConstructor
  ...
  void _openIt(AppModel app, BuildContext context, bool create,
      BookletModel model, EditorFeedback feedback) {
    openComplexDialog(
      app,
      context,
      ...
      child: BlocProvider<BookletBloc>(
          create: (context) => BookletBloc(
            ...
            */
                feedback,
              )..add(ExtEditorBaseInitialise<BookletModel>(model)),
          child: BookletComponentEditor(
            app: app,
          )),
    );
  }
...
class BookletComponentEditor extends StatefulWidget {
  final AppModel app;
...
class _BookletComponentEditorState
            ...
            return ListView(
                ...
                children: [
                  HeaderWidget(
                    ...
                    title: 'Booklet',
                    okAction: () async {
                      await BlocProvider.of<BookletBloc>(context).save(
                          ExtEditorBaseApplyChanges<BookletModel>(
                              model: bookletState.model));
                      return true;
                    },
                    cancelAction: () async {
                      return true;
  ...
  Widget _sections(ExtEditorBaseInitialised<BookletModel, dynamic> state) {
    List<SectionModel> items =
        state.model.sections != null ? state.model.sections! : [];
    return Container(
      height: 150,
          ...
          button(
            ...
            onPressed: () {
              open(
                  ...
                  (newItem) => BlocProvider.of<BookletBloc>(context)
